...
interface RestaurantSocialCardProps {
  instagramUrl?: string;
  twitterUrl?: string;
  tiktokOrDiscordUrl?: string;
  restaurantName?: string;
  className?: string;
}

export const RestaurantSocialCard: React.FC<RestaurantSocialCardProps> = ({
  instagramUrl,
  twitterUrl,
  tiktokOrDiscordUrl,
  ...
  return (
    <div className={`flex flex-col items-center gap-3 ${className}`}>
      <div className="text-center">
        <span className="text-[11px] font-black tracking-wider text-amber-500 uppercase block">
          تابع حسابات {restaurantName} 📲
        </span>
        <span className="text-xs text-slate-500 dark:text-slate-400 font-bold">
          مرر الماوس للتفاعل مع صفحاتنا
        </span>
      </div>

      <div className="rest-social-card">
        ...
        {/* Box 3: TikTok / Discord */}
        <a
          href={tiktokOrDiscordUrl || 'https://tiktok.com'}
          target="_blank"
          rel="noopener noreferrer"
          className="box box3"
          title="تيك توك / ديسكورد"
        >
          <span className="icon">
